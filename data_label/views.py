    ...
    def progress_detail(self, request):
        ...
        if os.path.exists(pictures_walet_path):
            for file in os.listdir(pictures_walet_path):
                ...
                media_url = media_path_to_url(file_path)
        ...
        if os.path.exists(result_file_path):
            ...
            for row in datas:
                ...
                if filename in filter_map:
                    response_data["result_file_content"].append({"FileName":filename, "FilePath": filter_map.get(filename), "Label": label})
            response_data["result_file"] = media_path_to_url(result_file_path)
